...
$slug = preg_match('/^slug:(.*)$/m', $metadata, $matches);
...
<head>
    <meta charset="utf-8" />
    <title><?php echo trim($page_title,"'"); ?> | Audio+Presetion 2 Scorm</title>
...
<body>
    <nav id="sidebar">
        <div id="header-wrapper">
            <div id="header">
                <a id="logo" href="?url=<?php echo $home; ?>"><img src="/docs/isotext.svg"></a>
            </div>
        </div>
