...
// Returns an elements total left offset from edge of client
...
if(-1!==r.indexOf(".")){var o=r.split(".")[1]
...
return n.setSeconds(t),e=n.toTimeString().replace(/.*(\d{2}:\d{2}:\d{2}).*/,"$1"),e.replace(/^00:/,"")}function timeAsSeconds(t){var e=0,n=(new Date(1970,0,1),t.split(":"))
return t.length>5?(e+=1200*Number(n[0]),e+=60*Number(n[1]),e+=Number(n[2])):(e+=60*Number(n[0]),e+=Number(n[1])),e}function dec2hex(t){return Number(t).toString(16)}function hex2dec(t){return parseInt(t,16)}function dataURItoBlob(t){for(var e=t.split(",")[0].split(":")[1].split(";")[0],n=atob(t.split(",")[1]),r=[],i=0;i<n.length;i++)r.push(n.charCodeAt(i))
...
n.eventType=e,t.fireEvent("on"+n.eventType,n)}}function elClientOffsetLeft(t){for(var e=t.offsetLeft,n=t.offsetParent;null!=n;)e+=n.offsetLeft,n=n.offsetParent
return e}!function(t){var e,n,r="0.4.2",i="hasOwnProperty",o=/[\.\/]/,a=function(){},s=function(t,e){return t-e},u={n:{}},l=function(t,r){t=String(t)
var i,o=n,a=Array.prototype.slice.call(arguments,2),u=l.listeners(t),c=0,f=[],d={},h=[],p=e
e=t,n=0
for(var g=0,v=u.length;v>g;g++)"zIndex"in u[g]&&(f.push(u[g].zIndex),u[g].zIndex<0&&(d[u[g].zIndex]=u[g]))
for(f.sort(s);f[c]<0;)if(i=d[f[c++]],h.push(i.apply(r,a)),n)return n=o,h
for(g=0;v>g;g++)if("zIndex"in(i=u[g]))if(i.zIndex==f[c]){if(h.push(i.apply(r,a)),n)break
do{if(c++,i=d[f[c]],i&&h.push(i.apply(r,a)),n)break}while(i)}else d[i.zIndex]=i
else if(h.push(i.apply(r,a)),n)break
return n=o,e=p,h.length?h:null}
l._events=u,l.listeners=function(t){var e,n,r,i,a,s,l,c,f=t.split(o),d=u,h=[d],p=[]
for(i=0,a=f.length;a>i;i++){for(c=[],s=0,l=h.length;l>s;s++)for(d=h[s].n,n=[d[f[i]],d["*"]],r=2;r--;)(e=n[r])&&(c.push(e),p=p.concat(e.f||[]))
h=c}return p},l.on=function(t,e){if(t=String(t),"function"!=typeof e)return function(){}
for(var n=t.split(o),r=u,i=0,s=n.length;s>i;i++)r=r.n,r=r.hasOwnProperty(n[i])&&r[n[i]]||(r[n[i]]={n:{}})
for(r.f=r.f||[],i=0,s=r.f.length;s>i;i++)if(r.f[i]==e)return a
return r.f.push(e),function(t){+t==+t&&(e.zIndex=+t)}},l.f=function(t){var e=[].slice.call(arguments,1)
return function(){l.apply(null,[t,null].concat(e).concat([].slice.call(arguments,0)))}},l.stop=function(){n=1},l.nt=function(t){return t?new RegExp("(?:\\.|\\/|^)"+t+"(?:\\.|\\/|$)").test(e):e},l.nts=function(){return e.split(o)},l.off=l.unbind=function(t,e){if(!t)return void(l._events=u={n:{}})
var n,r,a,s,c,f,d,h=t.split(o),p=[u]
for(s=0,c=h.length;c>s;s++)for(f=0;f<p.length;f+=a.length-2){if(a=[f,1],n=p[f].n,"*"!=h[s])n[h[s]]&&a.push(n[h[s]])
else for(r in n)n[i](r)&&a.push(n[r])
p.splice.apply(p,a)}for(s=0,c=p.length;c>s;s++)for(n=p[s];n.n;){if(e){if(n.f){for(f=0,d=n.f.length;d>f;f++)if(n.f[f]==e){n.f.splice(f,1)
break}!n.f.length&&delete n.f}for(r in n.n)if(n.n[i](r)&&n.n[r].f){var g=n.n[r].f
for(f=0,d=g.length;d>f;f++)if(g[f]==e){g.splice(f,1)
break}!g.length&&delete n.n[r].f}}else{delete n.f
for(r in n.n)n.n[i](r)&&n.n[r].f&&delete n.n[r].f}n=n.n}},l.once=function(t,e){var n=function(){return l.unbind(t,n),e.apply(this,arguments)}
return l.on(t,n)},l.version=r,l.toString=function(){return"You are running Eve "+r},"undefined"!=typeof module&&module.exports?module.exports=l:"undefined"!=typeof define?define("eve",[],function(){return l}):t.eve=l}(this),function(t,e){"function"==typeof define&&define.amd?define(["eve"],function(n){return e(t,n)}):e(t,t.eve)}(this,function(t,e){var n=function(e){var n={},r=t.requestAnimationFrame||t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.oRequestAnimationFrame||t.msRequestAnimationFrame||function(t){setTimeout(t,16)},i=Array.isArray||function(t){return t instanceof Array||"[object Array]"==Object.prototype.toString.call(t)},o=0,a="M"+(+new Date).toString(36),s=function(){return a+(o++).toString(36)},u=Date.now||function(){return+new Date},l=function(t){var e=this
...
n[y.id]=y
var x,b=0
for(x in n)if(n.hasOwnProperty(x)&&2==++b)break
return 1==b&&r(g),y}
...
if(null==e)return t=B.doc.querySelector(t),M(t)}return t=null==t?"100%":t,e=null==e?"100%":e,new k(t,e)}function i(t,e){if(e){if("string"==typeof t&&(t=i(t)),"string"==typeof e)return"xlink:"==e.substring(0,6)?t.getAttributeNS(it,e.substring(6)):"xml:"==e.substring(0,4)?t.getAttributeNS(ot,e.substring(4)):t.getAttribute(e)
for(var n in e)if(e[H](n)){var r=L(e[n])
r?"xlink:"==n.substring(0,6)?t.setAttributeNS(it,n.substring(6),r):"xml:"==n.substring(0,4)?t.setAttributeNS(ot,n.substring(4),r):t.setAttribute(n,r):t.removeAttribute(n)}}else t=B.doc.createElementNS(ot,t)
return t}function o(t,e){return e=L.prototype.toLowerCase.call(e),"finite"==e?isFinite(t):!("array"!=e||!(t instanceof Array||Array.isArray&&Array.isArray(t)))||("null"==e&&null===t||e==typeof t&&null!==t||"object"==e&&t===Object(t)||V.call(t).slice(8,-1).toLowerCase()==e)}function a(t){if("function"==typeof t||Object(t)!==t)return t
...
return a||s?(180+180*R.atan2(-s,-a)/G+360)%360:0}return l(t,e,i,o)-l(n,r,i,o)}function c(t){return t%360*G/180}function f(t){return 180*t/G%360}function d(t,e,n,r,i,o){return null==e&&"[object SVGMatrix]"==V.call(t)?(this.a=t.a,this.b=t.b,this.c=t.c,this.d=t.d,this.e=t.e,void(this.f=t.f)):void(null!=t?(this.a=+t,this.b=+e,this.c=+n,this.d=+r,this.e=+i,this.f=+o):(this.a=1,this.b=0,this.c=0,this.d=1,this.e=0,this.f=0))}function h(t){var e=[]
return t=t.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g,function(t,n,r){return r=r.split(/\s*,\s*|\s+/),"rotate"==n&&1==r.length&&r.push(0,0),"scale"==n&&(2==r.length&&r.push(0,0),1==r.length&&r.push(r[0],0,0)),"skewX"==n?e.push(["m",1,0,R.tan(c(r[0])),1,0,0]):"skewY"==n?e.push(["m",1,R.tan(c(r[0])),0,1,0,0]):e.push([n.charAt(0)].concat(r)),t}),e}function p(t,e){var n=gt(t),r=new d
...
if(!(e="linearGradient"==t.type||"radialGradient"==t.type?t.node.getAttribute("gradientTransform"):"pattern"==t.type?t.node.getAttribute("patternTransform"):t.node.getAttribute("transform")))return new d
...
return this}function b(t){if(t.snap in at)return at[t.snap]
var e,n=this.id=rt()
try{e=t.ownerSVGElement}catch(t){}if(this.node=t,e&&(this.paper=new k(e)),this.type=t.tagName,this.anims={},this._={transform:[]},t.snap=n,at[n]=this,"g"==this.type){this.add=x
...
if(t&&"svg"==t.tagName){if(t.snap in at)return at[t.snap]
n=new b(t),r=t.getElementsByTagName("desc")[0],o=t.getElementsByTagName("defs")[0],r||(r=i("desc"),r.appendChild(B.doc.createTextNode("Created with Snap")),n.node.appendChild(r)),o||(o=i("defs"),n.node.appendChild(o)),n.defs=o
for(var s in a)a[H](s)&&(n[s]=a[s])
n.paper=n.root=n}else n=C("svg",B.doc.body),i(n.node,{height:e,version:1.1,width:t,xmlns:ot})
...
return s.stops=E,s.addStop=T,s.getBBox=_,null!=e&&i(s.node,{cx:e,cy:n,r:r}),null!=o&&null!=a&&i(s.node,{fx:o,fy:a}),s}function N(t){return function(n){if(e.stop(),n instanceof S&&1==n.node.childNodes.length&&("radialGradient"==n.node.firstChild.tagName||"linearGradient"==n.node.firstChild.tagName||"pattern"==n.node.firstChild.tagName)&&(n=n.node.firstChild,m(this).appendChild(n),n=M(n)),n instanceof b)if("radialGradient"==n.type||"linearGradient"==n.type||"pattern"==n.type){n.node.id||i(n.node,{id:n.id})
var o=st(n.node.id)}else o=n.attr(t)
else if(o=r.color(n),o.error){var a=A(m(this),n)
a?(a.node.id||i(a.node,{id:a.id}),o=st(a.node.id)):o=n}else o=L(o)
var s={}
s[t]=o,i(this.node,s),this.node.style[t]=z}}function j(t){for(var e=[],n=t.childNodes,r=0,i=n.length;i>r;r++){var o=n[r]
...
var B={win:t,doc:t.document}
r._.glob=B
var H="hasOwnProperty",L=String,O=parseFloat,D=parseInt,R=Math,I=R.max,q=R.min,U=R.abs,G=(R.pow,R.PI),z=(R.round,""),V=Object.prototype.toString,X=/^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?%?)\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?%?)\s*\))\s*$/i,$=/^url\(#?([^)]+)\)$/,W="\t\n\v\f\r   ᠎             　\u2028\u2029",Y=new RegExp("[,"+W+"]+"),Z=(new RegExp("["+W+"]","g"),new RegExp("["+W+"]*,["+W+"]*")),J={hs:1,rg:1},Q=new RegExp("([a-z])["+W+",]*((-?\\d*\\.?\\d*(?:e[\\-+]?\\d+)?["+W+"]*,?["+W+"]*)+)","ig"),K=new RegExp("([rstm])["+W+",]*((-?\\d*\\.?\\d*(?:e[\\-+]?\\d+)?["+W+"]*,?["+W+"]*)+)","ig"),tt=new RegExp("(-?\\d*\\.?\\d*(?:e[\\-+]?\\d+)?)["+W+"]*,?["+W+"]*","ig"),et=0,nt="S"+(+new Date).toString(36),rt=function(){return nt+(et++).toString(36)},it="http://www.w3.org/1999/xlink",ot="http://www.w3.org/2000/svg",at={},st=r.url=function(t){return"url('#"+t+"')"}
r._.$=i,r._.id=rt,r.format=function(){var t=/\{([^\}]+)\}/g,e=/(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[('|")(.+?)\2\])(\(\))?/g,n=function(t,n,r){var i=r
...
var ut=function(){function t(){this.parentNode.removeChild(this)}return function(e,n){var r=B.doc.createElement("img"),i=B.doc.body
...
if(!(J[H](t.toLowerCase().substring(0,2))||"#"==t.charAt())&&(t=lt(t)),!t)return{r:-1,g:-1,b:-1,hex:"none",error:1,toString:dt}
var e,n,i,a,s,u,l=t.match(X)
return l?(l[2]&&(i=D(l[2].substring(5),16),n=D(l[2].substring(3,5),16),e=D(l[2].substring(1,3),16)),l[3]&&(i=D((s=l[3].charAt(3))+s,16),n=D((s=l[3].charAt(2))+s,16),e=D((s=l[3].charAt(1))+s,16)),l[4]&&(u=l[4].split(Z),e=O(u[0]),"%"==u[0].slice(-1)&&(e*=2.55),n=O(u[1]),"%"==u[1].slice(-1)&&(n*=2.55),i=O(u[2]),"%"==u[2].slice(-1)&&(i*=2.55),"rgba"==l[1].toLowerCase().slice(0,4)&&(a=O(u[3])),u[3]&&"%"==u[3].slice(-1)&&(a/=100)),l[5]?(u=l[5].split(Z),e=O(u[0]),"%"==u[0].slice(-1)&&(e/=100),n=O(u[1]),"%"==u[1].slice(-1)&&(n/=100),i=O(u[2]),"%"==u[2].slice(-1)&&(i/=100),("deg"==u[0].slice(-3)||"°"==u[0].slice(-1))&&(e/=360),"hsba"==l[1].toLowerCase().slice(0,4)&&(a=O(u[3])),u[3]&&"%"==u[3].slice(-1)&&(a/=100),r.hsb2rgb(e,n,i,a)):l[6]?(u=l[6].split(Z),e=O(u[0]),"%"==u[0].slice(-1)&&(e/=100),n=O(u[1]),"%"==u[1].slice(-1)&&(n/=100),i=O(u[2]),"%"==u[2].slice(-1)&&(i/=100),("deg"==u[0].slice(-3)||"°"==u[0].slice(-1))&&(e/=360),"hsla"==l[1].toLowerCase().slice(0,4)&&(a=O(u[3])),u[3]&&"%"==u[3].slice(-1)&&(a/=100),r.hsl2rgb(e,n,i,a)):(e=q(R.round(e),255),n=q(R.round(n),255),i=q(R.round(i),255),a=q(I(a,0),1),l={r:e,g:n,b:i,toString:dt},l.hex="#"+(16777216|i|n<<8|e<<16).toString(16).slice(1),l.opacity=o(a,"finite")?a:1,l)):{r:-1,g:-1,b:-1,hex:"none",error:1,toString:dt}},r),r.hsb=u(function(t,e,n){return r.hsb2rgb(t,e,n).hex}),r.hsl=u(function(t,e,n){return r.hsl2rgb(t,e,n).hex}),r.rgb=u(function(t,e,n,r){if(o(r,"finite")){var i=R.round
return"rgba("+[i(t),i(e),i(n),+r.toFixed(2)]+")"}return"#"+(16777216|n|e<<8|t<<16).toString(16).slice(1)})
var lt=function(t){var e=B.doc.getElementsByTagName("head")[0],n="rgb(255, 0, 0)"
return(lt=u(function(t){if("red"==t.toLowerCase())return n
e.style.color=n,e.style.color=t
var r=B.doc.defaultView.getComputedStyle(e,z).getPropertyValue("color")
...
t=i.r,e=i.g,n=i.b}return(t>1||e>1||n>1)&&(t/=255,e/=255,n/=255),[t,e,n]},pt=function(t,e,n,i){t=R.round(255*t),e=R.round(255*e),n=R.round(255*n)
...
var i,a,s,u,l
return t=t%360/60,l=n*e,u=l*(1-U(t%2-1)),i=a=s=n-l,t=~~t,i+=[l,u,0,0,u,l][t],a+=[u,l,l,u,0,0][t],s+=[0,0,u,l,l,u][t],pt(i,a,s,r)},r.hsl2rgb=function(t,e,n,r){o(t,"object")&&"h"in t&&"s"in t&&"l"in t&&(n=t.l,e=t.s,t=t.h),(t>1||e>1||n>1)&&(t/=360,e/=100,n/=100),t*=360
var i,a,s,u,l
return t=t%360/60,l=2*e*(.5>n?n:1-n),u=l*(1-U(t%2-1)),i=a=s=n-l/2,t=~~t,i+=[l,u,0,0,u,l][t],a+=[u,l,l,u,0,0][t],s+=[0,0,u,l,l,u][t],pt(i,a,s,r)},r.rgb2hsb=function(t,e,n){n=ht(t,e,n),t=n[0],e=n[1],n=n[2]
var r,i,o,a
return o=I(t,e,n),a=o-q(t,e,n),r=0==a?null:o==t?(e-n)/a:o==e?(n-t)/a+2:(t-e)/a+4,r=(r+360)%6*60/360,i=0==a?0:a/o,{h:r,s:i,b:o,toString:ct}},r.rgb2hsl=function(t,e,n){n=ht(t,e,n),t=n[0],e=n[1],n=n[2]
var r,i,o,a,s,u
return a=I(t,e,n),s=q(t,e,n),u=a-s,r=0==u?null:a==t?(e-n)/u:a==e?(n-t)/u+2:(t-e)/u+4,r=(r+360)%6*60/360,o=(a+s)/2,i=0==u?0:.5>o?u/(2*o):u/(2-2*o),{h:r,s:i,l:o,toString:ft}},r.parsePathString=function(t){if(!t)return null
var e=r.path(t)
if(e.arr)return r.path.clone(e.arr)
var n={a:7,c:6,o:2,h:1,l:2,m:2,r:4,q:4,s:4,t:2,v:1,u:3,z:0},i=[]
return o(t,"array")&&o(t[0],"array")&&(i=r.path.clone(t)),i.length||L(t).replace(Q,function(t,e,r){var o=[],a=e.toLowerCase()
if(r.replace(tt,function(t,e){e&&o.push(+e)}),"m"==a&&o.length>2&&(i.push([e].concat(o.splice(0,2))),a="l",e="m"==e?"l":"L"),"o"==a&&1==o.length&&i.push([e,o[0]]),"r"==a)i.push([e].concat(o))
else for(;o.length>=n[a]&&(i.push([e].concat(o.splice(0,n[a]))),n[a]););}),i.toString=r.path.toString,e.arr=r.path.clone(i),i}
var gt=r.parseTransformString=function(t){if(!t)return null
var e=[]
return o(t,"array")&&o(t[0],"array")&&(e=r.path.clone(t)),e.length||L(t).replace(K,function(t,n,r){var i=[]
n.toLowerCase(),r.replace(tt,function(t,e){e&&i.push(+e)}),e.push([n].concat(i))}),e.toString=r.path.toString,e}
r._.svgTransform2string=h,r._.rgTransform=new RegExp("^[a-z]["+W+"]*-?\\.?\\d","i"),r._.transform2matrix=p,r._unit2px=y
var vt=B.doc.contains||B.doc.compareDocumentPosition?function(t,e){var n=9==t.nodeType?t.documentElement:t,r=e&&e.parentNode
return t==r||!(!r||1!=r.nodeType||!(n.contains?n.contains(r):t.compareDocumentPosition&&16&t.compareDocumentPosition(r)))}:function(t,e){if(e)for(;e;)if((e=e.parentNode)==t)return!0
return!1}
r._.getSomeDefs=m,r.select=function(t){return M(B.doc.querySelector(t))},r.selectAll=function(t){for(var e=B.doc.querySelectorAll(t),n=(r.set||Array)(),i=0;i<e.length;i++)n.push(M(e[i]))
return n},function(t){function a(t){function e(t,e){var n=i(t.node,e)
n=n&&n.match(o),(n=n&&n[2])&&"#"==n.charAt()&&(n=n.substring(1))&&(s[n]=(s[n]||[]).concat(function(n){var r={}
r[e]=st(n),i(t.node,r)}))}for(var n,r=t.selectAll("*"),o=/^\s*url\(("|'|)(.*)\1\)\s*$/,a=[],s={},u=0,l=r.length;l>u;u++){n=r[u],e(n,"fill"),e(n,"stroke"),e(n,"filter"),e(n,"mask"),e(n,"clip-path"),function(t){var e=i(t.node,"xlink:href")
e&&"#"==e.charAt()&&(e=e.substring(1))&&(s[e]=(s[e]||[]).concat(function(e){t.attr("xlink:href","#"+e)}))}(n)
var c=i(n.node,"id")
c&&(i(n.node,{id:n.id}),a.push({old:c,id:n.id}))}for(u=0,l=a.length;l>u;u++){var f=s[a[u].old]
if(f)for(var d=0,h=f.length;h>d;d++)f[d](a[u].id)}}function s(t,e,n){return function(r){var i=r.slice(t,e)
...
return i(t.node,"id")&&i(t.node,{id:t.id}),a(t),t.insertAfter(this),t},t.toDefs=function(){return m(this).appendChild(this.node),this},t.pattern=function(t,e,n,r){var a=C("pattern",m(this))
...
return null==t&&(t=this.getBBox()),o(t,"object")&&"x"in t&&(e=t.y,n=t.width,r=t.height,a=t.refX||t.cx,s=t.refY||t.cy,t=t.x),i(u.node,{viewBox:[t,e,n,r].join(" "),markerWidth:n,markerHeight:r,orient:"auto",refX:a||0,refY:s||0,id:u.id}),u.node.appendChild(this.node),u}
...
return this}return e("snap.data.get."+this.id,this,i[t],t),i[t]}return i[t]=n,e("snap.data.set."+this.id,this,n,t),this},t.removeData=function(t){return null==t?f[this.id]={}:f[this.id]&&delete f[this.id][t],this},t.outerSVG=t.toString=u(1),t.innerSVG=u()}(b.prototype),r.parse=function(t){var e=B.doc.createDocumentFragment(),n=!0,r=B.doc.createElement("div")
...
return r.innerHTML=z,new S(e)},S.prototype.select=b.prototype.select,S.prototype.selectAll=b.prototype.selectAll,r.fragment=function(){for(var t=Array.prototype.slice.call(arguments,0),e=B.doc.createDocumentFragment(),n=0,i=t.length;i>n;n++){var o=t[n]
...
null!=e&&null!=n&&(u.x=e,u.y=n),null!=r&&null!=a?(u.width=r,u.height=a):ut(t,function(){i(s.node,{width:this.offsetWidth,height:this.offsetHeight})}),i(s.node,u)}return s},t.ellipse=function(t,e,n,r){var i=C("ellipse",this.node)
...
return o(t,"object")&&!o(t,"array")?e.attr(t):null!=t&&e.attr({points:t}),e},function(){t.gradient=function(t){return A(this.defs,t)},t.gradientLinear=function(t,e,n,r){return P(this.defs,t,e,n,r)},t.gradientRadial=function(t,e,n,r,i){return F(this.defs,t,e,n,r,i)},t.toString=function(){var t,e=B.doc.createDocumentFragment(),n=B.doc.createElement("div"),r=this.node.cloneNode(!0)
return e.appendChild(n),n.appendChild(r),i(r,{xmlns:ot}),t=n.innerHTML,e.removeChild(e.firstChild),t},t.clear=function(){for(var t,e=this.node.firstChild;e;)t=e.nextSibling,"defs"!=e.tagName&&e.parentNode.removeChild(e),e=t}}()}(k.prototype),r.ajax=function(t,n,r,i){var a=new XMLHttpRequest,s=rt()
...
i(this.node,{mask:st(n.id)})}}),function(t){e.on("snap.util.attr.clip",t),e.on("snap.util.attr.clip-path",t),e.on("snap.util.attr.clipPath",t)}(function(t){if(t instanceof b||t instanceof S){if(e.stop(),"clipPath"==t.type)var n=t
else n=C("clipPath",m(this)),n.node.appendChild(t.node),!n.node.id&&i(n.node,{id:n.id})
i(this.node,{"clip-path":st(n.id)})}}),e.on("snap.util.attr.fill",N("fill")),e.on("snap.util.attr.stroke",N("stroke"))
var mt=/^([lr])(?:\(([^)]*)\))?(.*)$/i
...
for(var n=B.doc.createTextNode(t);this.node.firstChild;)this.node.removeChild(this.node.firstChild)
...
s.appendChild(u.node),n=u.id,u.attr({id:n})}else(t=M(t))instanceof b&&((n=t.attr("id"))||(n=t.id,t.attr({id:n})))
...
var yt={"alignment-baseline":0,"baseline-shift":0,clip:0,"clip-path":0,"clip-rule":0,color:0,"color-interpolation":0,"color-interpolation-filters":0,"color-profile":0,"color-rendering":0,cursor:0,direction:0,display:0,"dominant-baseline":0,"enable-background":0,fill:0,"fill-opacity":0,"fill-rule":0,filter:0,"flood-color":0,"flood-opacity":0,font:0,"font-family":0,"font-size":0,"font-size-adjust":0,"font-stretch":0,"font-style":0,"font-variant":0,"font-weight":0,"glyph-orientation-horizontal":0,"glyph-orientation-vertical":0,"image-rendering":0,kerning:0,"letter-spacing":0,"lighting-color":0,marker:0,"marker-end":0,"marker-mid":0,"marker-start":0,mask:0,opacity:0,overflow:0,"pointer-events":0,"shape-rendering":0,"stop-color":0,"stop-opacity":0,stroke:0,"stroke-dasharray":0,"stroke-dashoffset":0,"stroke-linecap":0,"stroke-linejoin":0,"stroke-miterlimit":0,"stroke-opacity":0,"stroke-width":0,"text-anchor":0,"text-decoration":0,"text-rendering":0,"unicode-bidi":0,visibility:0,"word-spacing":0,"writing-mode":0}
...
yt[H](a)?this.node.style[o]=null==t?z:t:i(this.node,r)}),e.on("snap.util.getattr.transform",function(){return e.stop(),this.transform()})(-1),e.on("snap.util.getattr.textpath",function(){return e.stop(),this.textPath})(-1),function(){function t(t){return function(){e.stop()
var n=B.doc.defaultView.getComputedStyle(this.node,null).getPropertyValue("marker-"+t)
return"none"==n?n:r(B.doc.getElementById(n.match($)[1]))}}function n(t){return function(n){e.stop()
...
var t=i(this.node,"viewBox").split(Y)
return r._.box(+t[0],+t[1],+t[2],+t[3])})(-1),e.on("snap.util.getattr.points",function(){var t=i(this.node,"points")
return e.stop(),t.split(Y)}),e.on("snap.util.getattr.path",function(){var t=i(this.node,"d")
return e.stop(),t}),e.on("snap.util.getattr",function(){var t=e.nt()
t=t.substring(t.lastIndexOf(".")+1)
var n=t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})
return yt[H](n)?B.doc.defaultView.getComputedStyle(this.node,null).getPropertyValue(n):i(this.node,t)})
var xt=function(t){var e=t.getBoundingClientRect(),n=t.ownerDocument,r=n.body,i=n.documentElement,o=i.clientTop||r.clientTop||0,a=i.clientLeft||r.clientLeft||0
return{y:e.top+(g.win.pageYOffset||i.scrollTop||r.scrollTop)-o,x:e.left+(g.win.pageXOffset||i.scrollLeft||r.scrollLeft)-a}}
return r.getElementByPoint=function(t,e){var n=this,r=(n.canvas,B.doc.elementFromPoint(t,e))
if(B.win.opera&&"svg"==r.tagName){var i=xt(r),o=r.createSVGRect()
o.x=t-i.x,o.y=e-i.y,o.width=o.height=1
var a=r.getIntersectionList(o,null)
a.length&&(r=a[a.length-1])}return r?M(r):null},r.plugin=function(t){t(r,b,k,B)},B.win.Snap=r,r}()
...
continue}if(!n&&!r)return h=a(l,c,f[1],f[2],f[3],f[4],f[5],f[6],o-v)}v+=d,l=+f[5],c=+f[6]}p+=f.shift()+f}return g.end=p,h=n?v:r?g:u(l,c,f[0],f[1],f[2],f[3],f[4],f[5],1)},null,t._.clone)}function u(t,e,n,r,i,o,a,s,u){var l=1-u,c=z(l,3),f=z(l,2),d=u*u,h=d*u,p=c*t+3*f*u*n+3*l*u*u*i+h*a,g=c*e+3*f*u*r+3*l*u*u*o+h*s,v=t+2*u*(n-t)+d*(i-2*n+t),m=e+2*u*(r-e)+d*(o-2*r+e),y=n+2*u*(i-n)+d*(a-2*i+n),x=r+2*u*(o-r)+d*(s-2*o+r)
return{x:p,y:g,m:{x:v,y:m},n:{x:y,y:x},start:{x:l*t+u*n,y:l*e+u*r},end:{x:l*i+u*a,y:l*o+u*s},alpha:90-180*I.atan2(v-y,m-x)/q}}function l(e,n,i,o,a,s,u,l){t.is(e,"array")||(e=[e,n,i,o,a,s,u,l])
var c=P.apply(null,e)
return r(c.min.x,c.min.y,c.max.x-c.min.x,c.max.y-c.min.y)}function c(t,e,n){return e>=t.x&&e<=t.x+t.width&&n>=t.y&&n<=t.y+t.height}function f(t,e){return t=r(t),e=r(e),c(e,t.x,t.y)||c(e,t.x2,t.y)||c(e,t.x,t.y2)||c(e,t.x2,t.y2)||c(t,e.x,e.y)||c(t,e.x2,e.y)||c(t,e.x,e.y2)||c(t,e.x2,e.y2)||(t.x<e.x2&&t.x>e.x||e.x<t.x2&&e.x>t.x)&&(t.y<e.y2&&t.y>e.y||e.y<t.y2&&e.y>t.y)}function d(t,e,n,r,i){return t*(t*(-3*e+9*n-9*r+3*i)+6*e-12*n+6*r)-3*e+3*n}function h(t,e,n,r,i,o,a,s,u){null==u&&(u=1),u=u>1?1:0>u?0:u
for(var l=u/2,c=[-.1252,.1252,-.3678,.3678,-.5873,.5873,-.7699,.7699,-.9041,.9041,-.9816,.9816],f=[.2491,.2491,.2335,.2335,.2032,.2032,.1601,.1601,.1069,.1069,.0472,.0472],h=0,p=0;12>p;p++){var g=l*c[p]+l,v=d(g,t,n,i,a),m=d(g,e,r,o,s),y=v*v+m*m
h+=f[p]*I.sqrt(y)}return l*h}function p(t,e,n,r,i,o,a,s,u){if(!(0>u||h(t,e,n,r,i,o,a,s)<u)){var l,c=.5,f=1-c
for(l=h(t,e,n,r,i,o,a,s,f);V(l-u)>.01;)c/=2,f+=(u>l?1:-1)*c,l=h(t,e,n,r,i,o,a,s,f)
return f}}function g(t,e,n,r,i,o,a,s){if(!(G(t,n)<U(i,a)||U(t,n)>G(i,a)||G(e,r)<U(o,s)||U(e,r)>G(o,s))){var u=(t*r-e*n)*(i-a)-(t-n)*(i*s-o*a),l=(t*r-e*n)*(o-s)-(e-r)*(i*s-o*a),c=(t-n)*(o-s)-(e-r)*(i-a)
if(c){var f=u/c,d=l/c,h=+f.toFixed(2),p=+d.toFixed(2)
if(!(h<+U(t,n).toFixed(2)||h>+G(t,n).toFixed(2)||h<+U(i,a).toFixed(2)||h>+G(i,a).toFixed(2)||p<+U(e,r).toFixed(2)||p>+G(e,r).toFixed(2)||p<+U(o,s).toFixed(2)||p>+G(o,s).toFixed(2)))return{x:f,y:d}}}}function v(t,e,n){if(!f(l(t),l(e)))return n?0:[]
for(var r=h.apply(0,t),i=h.apply(0,e),o=~~(r/5),a=~~(i/5),s=[],c=[],d={},p=n?0:[],v=0;o+1>v;v++){var m=u.apply(0,t.concat(v/o))
s.push({x:m.x,y:m.y,t:v/o})}for(v=0;a+1>v;v++)m=u.apply(0,e.concat(v/a)),c.push({x:m.x,y:m.y,t:v/a})
for(v=0;o>v;v++)for(var y=0;a>y;y++){var x=s[v],b=s[v+1],w=c[y],S=c[y+1],C=V(b.x-x.x)<.001?"y":"x",k=V(S.x-w.x)<.001?"y":"x",M=g(x.x,x.y,b.x,b.y,w.x,w.y,S.x,S.y)
if(M){if(d[M.x.toFixed(4)]==M.y.toFixed(4))continue
d[M.x.toFixed(4)]=M.y.toFixed(4)
var E=x.t+V((M[C]-x[C])/(b[C]-x[C]))*(b.t-x.t),T=w.t+V((M[k]-w[k])/(S[k]-w[k]))*(S.t-w.t)
E>=0&&1>=E&&T>=0&&1>=T&&(n?p++:p.push({x:M.x,y:M.y,t1:E,t2:T}))}}return p}function m(t,e){return x(t,e)}function y(t,e){return x(t,e,1)}function x(t,e,n){t=F(t),e=F(e)
...
for(var h,p,g=3==e.length&&"M"==e[0][0]&&"R"==e[1][0].toUpperCase()&&"Z"==e[2][0].toUpperCase(),v=d,m=e.length;m>v;v++){if(s.push(h=[]),p=e[v],(a=p[0])!=a.toUpperCase())switch(h[0]=a.toUpperCase(),h[0]){case"A":h[1]=p[1],h[2]=p[2],h[3]=p[3],h[4]=p[4],h[5]=p[5],h[6]=+(p[6]+u),h[7]=+(p[7]+l)
break
case"V":h[1]=+p[1]+l
break
case"H":h[1]=+p[1]+u
...
default:for(x=1,b=p.length;b>x;x++)h[x]=+p[x]+(x%2?u:l)}else if("R"==a)y=[u,l].concat(p.slice(1)),s.pop(),s=s.concat(j(y,g)),h=["R"].concat(p.slice(-2))
...
if("O"!=(a=a.toUpperCase()))switch(h[0]){case"Z":u=c,l=f
break
case"H":u=h[1]
break
case"V":l=h[1]
...
return[a*t+s*n,a*e+s*r,a*i+s*n,a*o+s*r,i,o]}function _(e,n,r,i,o,a,s,u,l,c){var f,d=120*q/180,h=q/180*(+o||0),p=[],g=t._.cacher(function(t,e,n){return{x:t*I.cos(n)-e*I.sin(n),y:t*I.sin(n)+e*I.cos(n)}})
...
var F=I.cos(k),N=I.sin(k),j=I.cos(M),B=I.sin(M),H=I.tan(E/4),L=4/3*r*H,O=4/3*i*H,D=[e,n],R=[e+L*N,n-O*F],U=[u+L*B,l-O*j],G=[u,l]
...
s.x=p[v-2],s.y=p[v-1],s.bx=R(p[v-4])||s.x,s.by=R(p[v-3])||s.y,u.bx=a&&(R(g[m-4])||u.x),u.by=a&&(R(g[m-3])||u.y),u.x=a&&g[m-2],u.y=a&&g[m-1]}return a||(r.curve=o(i)),a?[i,a]:i}function N(t,e){if(!e)return t
var n,r,i,o,a,s,u
...
e?r?i-4==r?o[3]={x:+t[0],y:+t[1]}:i-2==r&&(o[2]={x:+t[0],y:+t[1]},o[3]={x:+t[2],y:+t[3]}):o[0]={x:+t[i-2],y:+t[i-1]}:i-4==r?o[3]=o[2]:r||(o[0]={x:+t[r],y:+t[r+1]}),n.push(["C",(-o[0].x+6*o[1].x+o[2].x)/6,(-o[0].y+6*o[1].y+o[2].y)/6,(o[1].x+6*o[2].x-o[3].x)/6,(o[1].y+6*o[2].y-o[3].y)/6,o[2].x,o[2].y])}return n}var B=e.prototype,H=t.is,L=t._.clone,O="hasOwnProperty",D=/,?([a-z]),?/gi,R=parseFloat,I=Math,q=I.PI,U=I.min,G=I.max,z=I.pow,V=I.abs,X=s(1),$=s(),W=s(0,1),Y=t._unit2px,Z={path:function(t){return t.attr("path")},circle:function(t){var e=Y(t)
...
var r=W(t,n,1)
return e?W(r,e).end:r},B.getTotalLength=function(){return this.node.getTotalLength?this.node.getTotalLength():void 0},B.getPointAtLength=function(t){return $(this.attr("d"),t)},B.getSubpath=function(e,n){return t.path.getSubpath(this.attr("d"),e,n)},t._.box=r,t.path.findDotsAtSegment=u,t.path.bezierBBox=l,t.path.isPointInsideBBox=c,t.path.isBBoxIntersect=f,t.path.intersection=m,t.path.intersectionNumber=y,t.path.isPointInside=b,t.path.getBBox=w,t.path.get=Z,t.path.toRelative=k,t.path.toAbsolute=M,t.path.toCubic=F,t.path.map=N,t.path.toString=i,t.path.clone=o}),r.plugin(function(t){var e=Math.max,n=Math.min,r=function(t){if(this.items=[],this.length=0,this.type="set",t)for(var e=0,n=t.length;n>e;e++)t[e]&&(this[this.items.length]=this.items[this.items.length]=t[e],this.length++)},i=r.prototype
i.push=function(){for(var t,e,n=0,r=arguments.length;r>n;n++)(t=arguments[n])&&(e=this.items.length,this[e]=this.items[e]=t,this.length++)
return this},i.pop=function(){return this.length&&delete this[this.length--],this.items.pop()},i.forEach=function(t,e){for(var n=0,r=this.items.length;r>n;n++)if(!1===t.call(e,this.items[n],n))return this
...
return v&&v==m?{from:parseFloat(p),to:parseFloat(n),f:o(v)}:{from:this.asPX(e),to:this.asPX(e,n),f:i}}}),r.plugin(function(t,n,r,i){for(var o=n.prototype,a=("createTouch"in i.doc),s=["click","dblclick","mousedown","mousemove","mouseout","mouseover","mouseup","touchstart","touchmove","touchend","touchcancel"],u={mousedown:"touchstart",mousemove:"touchmove",mouseup:"touchend"},l=function(t){var e="y"==t?"scrollTop":"scrollLeft"
return i.doc.documentElement[e]||i.doc.body[e]},c=function(){this.returnValue=!1},f=function(){return this.originalEvent.preventDefault()},d=function(){this.cancelBubble=!0},h=function(){return this.originalEvent.stopPropagation()},p=function(){return i.doc.addEventListener?function(t,e,n,r){var i=a&&u[e]?u[e]:e,o=function(i){var o=l("y"),s=l("x")
if(a&&u.hasOwnProperty(e))for(var c=0,d=i.targetTouches&&i.targetTouches.length;d>c;c++)if(i.targetTouches[c].target==t||t.contains(i.targetTouches[c].target)){var p=i
i=i.targetTouches[c],i.originalEvent=p,i.preventDefault=f,i.stopPropagation=h
break}var g=i.clientX+s,v=i.clientY+o
...
var e=l("y"),o=l("x"),a=t.clientX+o,s=t.clientY+e
return t.preventDefault=t.preventDefault||c,t.stopPropagation=t.stopPropagation||d,n.call(r,t,a,s)}
return t.attachEvent("on"+e,o),function(){return t.detachEvent("on"+e,o),!0}}:void 0}(),g=[],v=function(n){for(var r,i=n.clientX,o=n.clientY,s=l("y"),u=l("x"),c=g.length;c--;){if(r=g[c],a){for(var f,d=n.touches&&n.touches.length;d--;)if(f=n.touches[d],f.identifier==r.el._drag.id||r.el.node.contains(f.target)){i=f.clientX,o=f.clientY,(n.originalEvent?n.originalEvent:n).preventDefault()
break}}else n.preventDefault()
var h=r.el.node
t._.glob,h.nextSibling,h.parentNode,h.style.display,i+=u,o+=s,e("snap.drag.move."+r.el.id,r.move_scope||r.el,i-r.el._drag.x,o-r.el._drag.y,i,o,n)}},m=function(n){t.unmousemove(v).unmouseup(m)
for(var r,i=g.length;i--;)r=g[i],r.el._drag={},e("snap.drag.end."+r.el.id,r.end_scope||r.start_scope||r.move_scope||r.el,n)
g=[]},y=s.length;y--;)!function(e){t[e]=o[e]=function(n,r){return t.is(n,"function")&&(this.events=this.events||[],this.events.push({name:e,f:n,unbind:p(this.shape||this.node||i.doc,e,n,r||this)})),this},t["un"+e]=o["un"+e]=function(t){for(var n=this.events||[],r=n.length;r--;)if(n[r].name==e&&(n[r].f==t||!t))return n[r].unbind(),n.splice(r,1),!n.length&&delete this.events,this
return this}}(s[y])
...
var x=[]
o.drag=function(n,r,i,o,a,s){function u(u,l,c){(u.originalEvent||u).preventDefault(),this._drag.x=l,this._drag.y=c,this._drag.id=u.identifier,!g.length&&t.mousemove(v).mouseup(m),g.push({el:this,move_scope:o,start_scope:a,end_scope:s}),r&&e.on("snap.drag.start."+this.id,r),n&&e.on("snap.drag.move."+this.id,n),i&&e.on("snap.drag.end."+this.id,i),e("snap.drag.start."+this.id,a||o||this,l,c,u)}if(!arguments.length){var l
return this.drag(function(t,e){this.attr({transform:l+(l?"T":"t")+[t,e]})},function(){l=this.transform().local})}return this._drag={},x.push({el:this,start:u}),this.mousedown(u),this},o.undrag=function(){for(var n=x.length;n--;)x[n].el==this&&(this.unmousedown(x[n].start),x.splice(n,1),e.unbind("snap.drag.*."+this.id))
return!x.length&&t.unmousemove(v).unmouseup(m),this}}),r.plugin(function(t,n,r){var i=(n.prototype,r.prototype),o=/^\s*url\((.+)\)/,a=String,s=t._.$
...
var r=null==n?e:[e,n]
return t.format('<feGaussianBlur stdDeviation="{def}"/>',{def:r})},t.filter.blur.toString=function(){return this()},t.filter.shadow=function(e,n,r,i){return i=i||"#000",null==r&&(r=4),"string"==typeof r&&(i=r,r=4),null==e&&(e=0,n=2),null==n&&(n=e),i=t.color(i),t.format('<feGaussianBlur in="SourceAlpha" stdDeviation="{blur}"/><feOffset dx="{dx}" dy="{dy}" result="offsetblur"/><feFlood flood-color="{color}"/><feComposite in2="offsetblur" operator="in"/><feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge>',{color:i,dx:e,dy:n,blur:r})},t.filter.shadow.toString=function(){return this()},t.filter.grayscale=function(e){return null==e&&(e=1),t.format('<feColorMatrix type="matrix" values="{a} {b} {c} 0 0 {d} {e} {f} 0 0 {g} {b} {h} 0 0 0 0 0 1 0"/>',{a:.2126+.7874*(1-e),b:.7152-.7152*(1-e),c:.0722-.0722*(1-e),d:.2126-.2126*(1-e),e:.7152+.2848*(1-e),f:.0722-.0722*(1-e),g:.2126-.2126*(1-e),h:.0722+.9278*(1-e)})},t.filter.grayscale.toString=function(){return this()},t.filter.sepia=function(e){return null==e&&(e=1),t.format('<feColorMatrix type="matrix" values="{a} {b} {c} 0 0 {d} {e} {f} 0 0 {g} {h} {i} 0 0 0 0 0 1 0"/>',{a:.393+.607*(1-e),b:.769-.769*(1-e),c:.189-.189*(1-e),d:.349-.349*(1-e),e:.686+.314*(1-e),f:.168-.168*(1-e),g:.272-.272*(1-e),h:.534-.534*(1-e),i:.131+.869*(1-e)})},t.filter.sepia.toString=function(){return this()},t.filter.saturate=function(e){return null==e&&(e=1),t.format('<feColorMatrix type="saturate" values="{amount}"/>',{amount:1-e})},t.filter.saturate.toString=function(){return this()},t.filter.hueRotate=function(e){return e=e||0,t.format('<feColorMatrix type="hueRotate" values="{angle}"/>',{angle:e})},t.filter.hueRotate.toString=function(){return this()},t.filter.invert=function(e){return null==e&&(e=1),t.format('<feComponentTransfer><feFuncR type="table" tableValues="{amount} {amount2}"/><feFuncG type="table" tableValues="{amount} {amount2}"/><feFuncB type="table" tableValues="{amount} {amount2}"/></feComponentTransfer>',{amount:e,amount2:1-e})},t.filter.invert.toString=function(){return this()},t.filter.brightness=function(e){return null==e&&(e=1),t.format('<feComponentTransfer><feFuncR type="linear" slope="{amount}"/><feFuncG type="linear" slope="{amount}"/><feFuncB type="linear" slope="{amount}"/></feComponentTransfer>',{amount:e})},t.filter.brightness.toString=function(){return this()},t.filter.contrast=function(e){return null==e&&(e=1),t.format('<feComponentTransfer><feFuncR type="linear" slope="{amount}" intercept="{amount2}"/><feFuncG type="linear" slope="{amount}" intercept="{amount2}"/><feFuncB type="linear" slope="{amount}" intercept="{amount2}"/></feComponentTransfer>',{amount:e,amount2:.5-e/2})},t.filter.contrast.toString=function(){return this()}}),r}),window.Modernizr=function(t,e,n){function r(t){p.cssText=t}function i(t,e){return typeof t===e}function o(t,e){return!!~(""+t).indexOf(e)}function a(t,e){for(var r in t){var i=t[r]
if(!o(i,"-")&&p[i]!==n)return"pfx"!=e||i}return!1}function s(t,e,r){for(var o in t){var a=e[t[o]]
if(a!==n)return!1===r?t[o]:i(a,"function")?a.bind(r||e):a}return!1}function u(t,e,n){var r=t.charAt(0).toUpperCase()+t.slice(1),o=(t+" "+v.join(r+" ")+r).split(" ")
return i(e,"string")||i(e,"undefined")?a(o,e):(o=(t+" "+m.join(r+" ")+r).split(" "),s(o,e,n))}var l,c,f={},d=e.documentElement,h=e.createElement("modernizr"),p=h.style,g="Webkit Moz O ms",v=g.split(" "),m=g.toLowerCase().split(" "),y={},x=[],b=x.slice,w={}.hasOwnProperty
c=i(w,"undefined")||i(w.call,"undefined")?function(t,e){return e in t&&i(t.constructor.prototype[e],"undefined")}:function(t,e){return w.call(t,e)},Function.prototype.bind||(Function.prototype.bind=function(t){var e=this
if("function"!=typeof e)throw new TypeError
var n=b.call(arguments,1),r=function(){if(this instanceof r){var i=function(){}
i.prototype=e.prototype
var o=new i,a=e.apply(o,n.concat(b.call(arguments)))
return Object(a)===a?a:o}return e.apply(t,n.concat(b.call(arguments)))}
return r}),y.csstransitions=function(){return u("transition")}
for(var S in y)c(y,S)&&(l=S.toLowerCase(),f[l]=y[S](),x.push((f[l]?"":"no-")+l))
return f.addTest=function(t,e){if("object"==typeof t)for(var r in t)c(t,r)&&f.addTest(r,t[r])
else{if(t=t.toLowerCase(),f[t]!==n)return f
e="function"==typeof e?e():e,d.className+=" "+(e?"":"no-")+t,f[t]=e}return f},r(""),h=null,function(t,e){function n(t,e){var n=t.createElement("p"),r=t.getElementsByTagName("head")[0]||t.documentElement
return n.innerHTML="x<style>"+e+"</style>",r.insertBefore(n.lastChild,r.firstChild)}function r(){var t=m.elements
return"string"==typeof t?t.split(" "):t}function i(t){var e=v[t[p]]
return e||(e={},g++,t[p]=g,v[g]=e),e}function o(t,n,r){if(n||(n=e),c)return n.createElement(t)
r||(r=i(n))
var o
return o=r.cache[t]?r.cache[t].cloneNode():h.test(t)?(r.cache[t]=r.createElem(t)).cloneNode():r.createElem(t),!o.canHaveChildren||d.test(t)||o.tagUrn?o:r.frag.appendChild(o)}function a(t,n){if(t||(t=e),c)return t.createDocumentFragment()
n=n||i(t)
...
var r=i(t)
return m.shivCSS&&!l&&!r.hasCSS&&(r.hasCSS=!!n(t,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),c||s(t,r),t}var l,c,f=t.html5||{},d=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,h=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,p="_html5shiv",g=0,v={}
...
return void 0===t.cloneNode||void 0===t.createDocumentFragment||void 0===t.createElement}()}catch(t){l=!0,c=!0}}()
var m={elements:f.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:"3.7.0",shivCSS:!1!==f.shivCSS,supportsUnknownElements:c,shivMethods:!1!==f.shivMethods,type:"default",shivDocument:u,createElement:o,createDocumentFragment:a}
t.html5=m,u(e)}(this,e),f._version="2.7.1",f._domPrefixes=m,f._cssomPrefixes=v,f.testProp=function(t){return a([t])},f.testAllProps=u,f.prefixed=function(t,e,n){return e?u(t,e,n):u(t,"pfx")},d.className=d.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+" js "+x.join(" "),f}(0,this.document),function(t,e,n){function r(t){return"[object Function]"==v.call(t)}function i(t){return"string"==typeof t}function o(){}function a(t){return!t||"loaded"==t||"complete"==t||"uninitialized"==t}function s(){var t=m.shift()
...
var o=n(4),a=n(5),s=i(a),u=n(6),l=n(14),c=n(16),f=i(c)
e.VERSION="4.0.5"
...
var h="[object Object]"
r.prototype={constructor:r,logger:f.default,log:f.default.log,registerHelper:function(t,e){if(o.toString.call(t)===h){if(e)throw new s.default("Arg not supported with multiple helpers")
o.extend(this.helpers,t)}else this.helpers[t]=e},unregisterHelper:function(t){delete this.helpers[t]},registerPartial:function(t,e){if(o.toString.call(t)===h)o.extend(this.partials,t)
else{if(void 0===e)throw new s.default('Attempting to register a partial called "'+t+'" as undefined')
this.partials[t]=e}},unregisterPartial:function(t){delete this.partials[t]},registerDecorator:function(t,e){if(o.toString.call(t)===h){if(e)throw new s.default("Arg not supported with multiple decorators")
o.extend(this.decorators,t)}else this.decorators[t]=e},unregisterDecorator:function(t){delete this.decorators[t]}}
var p=f.default.log
e.log=p,e.createFrame=o.createFrame,e.logger=f.default},function(t,e){"use strict"
...
e.__esModule=!0,e.default=function(t){var e=void 0!==n?n:window,r=e.Handlebars
...
if(!(void 0===t||"undefined"!=typeof navigator&&/MSIE [1-9]\./.test(navigator.userAgent))){var e=t.document,n=function(){return t.URL||t.webkitURL||t},r=e.createElementNS("http://www.w3.org/1999/xhtml","a"),i="download"in r,o=function(t){var e=new MouseEvent("click")
t.dispatchEvent(e)},a=/constructor/i.test(t.HTMLElement)||t.safari,s=/CriOS\/[\d]+/.test(navigator.userAgent),u=function(e){(t.setImmediate||t.setTimeout)(function(){throw e},0)},l=function(t){var e=function(){"string"==typeof t?n().revokeObjectURL(t):t.remove()}
setTimeout(e,4e4)},c=function(t,e,n){e=[].concat(e)
for(var r=e.length;r--;){var i=t["on"+e[r]]
if("function"==typeof i)try{i.call(t,n||t)}catch(t){u(t)}}},f=function(t){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(t.type)?new Blob([String.fromCharCode(65279),t],{type:t.type}):t},d=function(e,u,d){d||(e=f(e))
var h,p=this,g=e.type,v="application/octet-stream"===g,m=function(){c(p,"writestart progress write writeend".split(" "))}
if(p.readyState=p.INIT,i)return h=n().createObjectURL(e),void setTimeout(function(){r.href=h,r.download=u,o(r),m(),l(h),p.readyState=p.DONE})
!function(){if((s||v&&a)&&t.FileReader){var r=new FileReader
return r.onloadend=function(){var e=s?r.result:r.result.replace(/^data:[^;]*;/,"data:attachment/file;")
t.open(e,"_blank")||(t.location.href=e),e=void 0,p.readyState=p.DONE,m()},r.readAsDataURL(e),void(p.readyState=p.INIT)}if(h||(h=n().createObjectURL(e)),v)t.location.href=h
else{t.open(h,"_blank")||(t.location.href=h)}p.readyState=p.DONE,m(),l(h)}()},h=d.prototype,p=function(t,e,n){return new d(t,e||t.name||"download",n)}
...
void 0===navigator.mediaDevices&&(navigator.mediaDevices={}),void 0===navigator.mediaDevices.getUserMedia&&(navigator.mediaDevices.getUserMedia=t)}(),Number.prototype.clamp=function(t,e){return Math.min(Math.max(this,t),e)}
